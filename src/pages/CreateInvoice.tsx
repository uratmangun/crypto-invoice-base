...
export function CreateInvoice() {
  ...
  const generateInvoice = () => {
    // Generate a mock payment link (in real app, this would be generated by backend)
    const mockPaymentLink = `https://crypto-invoice.app/pay/${invoiceData.invoiceNumber}`
  ...
  const isFormValid = invoiceData.clientName && invoiceData.clientEmail && 
                     invoiceData.description && invoiceData.amount && 
                     invoiceData.dueDate && invoiceData.walletAddress
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      ...
                      <p className="font-semibold text-gray-900 dark:text-white">{invoiceData.dueDate}</p>
                    </div>
                  </div>
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <Label htmlFor="clientAddress" className="flex items-center gap-2 mb-2">
